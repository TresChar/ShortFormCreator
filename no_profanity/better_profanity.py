...
class Profanity:
    ...
    def censor(self, text, censor_char="*",censor_word=None):
        ...
        if censor_word!=None:
            return self._hide_swear_words_with_words(text,censor_word)
        else:
    ...
    def _hide_swear_words_with_words(self,text,censor_word):
        """Replace the swear words with censor words"""
        censored_text = ""
        cur_word = ""
        skip_index = -1
        next_words_indices = []
